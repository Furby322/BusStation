    ...
    <div class="text-center">
        ...
        <table class="table table-dark {{--col-md-8--}}">
            ...
            @foreach($repairs as $repair)
                ...
                <tr>
                    <th scope="row">{{ $repair->car_park->types->type }}</th>
                    {{--                    <td>{{ $car->type_transports->type  }}</td>--}}
                    <td>{{ $repair->car_park->models->brands->name }}</td>
        ...
        {!! Form::open(array('route' => 'query_11_brands')) !!}
        ...
        {!! Form::open(array('route' => 'query_11_types')) !!}
        ...
        {!! Form::open(array('route' => 'query_11_cars')) !!}
